...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/icons-page-1603a27e.js").then((m) => m.default || m)
  },
  {
    name: "antique-brass",
    path: "/antique-brass",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/antique-brass-a6b359d6.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/cornflower-blue-d9d63a3a.js").then((m) => m.default || m)
  },
  {
    name: "iceberg",
    path: "/iceberg",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/iceberg-e7966f23.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-6d00e25c.js").then((m) => m.default || m)
  },
  {
    name: "polished-pine",
    path: "/polished-pine",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/polished-pine-90884c12.js").then((m) => m.default || m)
  },
  {
    name: "purple",
    path: "/purple",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/purple-cff7c9f2.js").then((m) => m.default || m)
  },
  {
    name: "spanish-gray",
    path: "/spanish-gray",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/spanish-gray-6a858e96.js").then((m) => m.default || m)
  }
];
...
const LazySvgIcon = defineAsyncComponent(() => import("./_nuxt/svg-icon-8b1d6f4a.js").then((r) => r.default));
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/default-10e50421.js").then((m) => m.default || m)),
  "svg-sprite": /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/svg-sprite-eb781834.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-502a7e4c.js").then((r) => r.default || r));
