...
The color name of hex code #6E92EF is Cornflower Blue. The RGB values are (110, 146, 239) which means it is composed of 22% red, 29% green and 48% blue. The CMYK color codes, used in printers, are C:54 M:39 Y:0 K:6. In the HSV/HSB scale, #6E92EF has a hue of 223\xB0, 54% saturation and a brightness value of 94%.
...
//# sourceMappingURL=cornflower-blue-d9d63a3a.mjs.map
